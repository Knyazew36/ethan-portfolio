...
const Nav = () => {
  ...
  return (
    <nav className="flex flex-col items-center xl:justify-center bg-red-500/30 p-20 gap-y-4 fixed h-max bottom-0 mt-auto xl:right-[2%] z-50 top-0 w-full xl:w-12 xl:max-w-md xl:h-screen ">
